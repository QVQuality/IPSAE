...
#  python ipsae.py <path_to_af2_pae_file>     <path_to_af2_pdb_file>     <pae_cutoff> <dist_cutoff> [<outdir>]
#  python ipsae.py <path_to_af3_pae_file>     <path_to_af3_cif_file>     <pae_cutoff> <dist_cutoff> [<outdir>]
#  python ipsae.py <path_to_boltz1_pae_file>  <path_to_boltz1_cif_file>  <pae_cutoff> <dist_cutoff> [<outdir>]
...
if len(sys.argv) < 5:
    print("Usage for AF2:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_pdb_file> <pae_cutoff> <dist_cutoff> [<outdir>]")
    ...
    print("")
    print("Usage for AF3:")
    print("   python ipsae.py <path_to_pae_json_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff> [<outdir>]")
    print("   python ipsae.py fold_aurka_tpx2_full_data_0.json  fold_aurka_tpx2_model_0.cif 10 10")
    print("")
    print("Usage for Boltz1:")
    print("   python ipsae.py <path_to_pae_npz_file> <path_to_mmcif_file> <pae_cutoff> <dist_cutoff> [<outdir>]")
    print("   python ipsae.py pae_AURKA_TPX2_model_0.npz  AURKA_TPX2_model_0.cif 10 10")
    print("")
    print("If no <outdir> is provided, all 3 output files will be in same path/folder as cif or pdb file.")
    sys.exit(1)
...
file_path = Path(path_stem + ".txt").name
file2_path = Path(path_stem + "_byres.txt").name
pml_path = Path(path_stem + ".pml").name
OUT = open(outdir / file_path, 'w')
PML = open(outdir / pml_path, 'w')
OUT2 = open(outdir / file2_path, 'w')
print("Will be writting output files to ", outdir)
